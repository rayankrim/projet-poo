...
public class Somme extends OperationBinaire{

	public Somme(ExpressionArithmetique nombre, ExpressionArithmetique max) {
		super(nombre,max);
	}
	...
	public String afficher() {
		...
		if(this.eaLeft instanceof Multiplication) {
			...
			Puissance ealeftRight=(Puissance) ealeft.eaRight;
			VarSymbolique ealeftLeftRight=(VarSymbolique) ealeftLeft.eaRight;
			VarSymbolique ealeftLeftLeft=(VarSymbolique) ealeftRight.eaRight;
			for(int i=0; i<=this.eaRight.calculer();i++) {
				ealeftLeftLeft.setValue(i);;
				ealeftLeftRight.setValue(i);
